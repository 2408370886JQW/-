            ...
            {filterTabs.map(tab => {
              ...
              return (
                <motion.button
                  ...
                  className={cn(
                    "px-3 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-colors flex items-center gap-1 shrink-0",
                ...
                >
                  ...
                  {count > 0 && (
                    <span className={cn(
                      "text-xs min-w-[18px] text-center px-1 py-0.5 rounded-full inline-block",
