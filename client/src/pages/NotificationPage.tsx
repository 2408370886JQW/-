...
const NOTIFICATIONS = [
  ...
  { id: 2, type: "follow", user: "Bob", avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&fit=crop", content: "关注了你", time: "1小时前", read: false },
          ...
          {notifications.map(notification => (
            ...
            >
              ...
              {notification.type === "follow" && (
                <button className="self-center ml-2 px-3 py-1.5 bg-slate-900 text-white text-xs font-bold rounded-full shadow-sm active:scale-95 transition-transform">
                  回关
                </button>
              )}
            </div>
