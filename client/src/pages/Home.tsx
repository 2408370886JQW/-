          ...
          {activeTab === "meet" && (
            ...
            >
              {showStoreMode ? (
                ...
                <div className="flex-1 overflow-y-auto p-4 pb-32 pt-14 relative overscroll-contain touch-pan-y">
                  {/* Back Button */}
                  <button 
                  ...
                  <div className="space-y-4 pb-4">
                    {[
                      ...
                      <Link key={i} href={`/merchant/${shop.id}`}>
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-100 flex gap-4 active:scale-[0.98] transition-transform cursor-pointer mb-4">
